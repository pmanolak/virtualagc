...
- **Pre-compiled**: Uses the official VirtualAGC repository with compiled binaries
...
The container runs with the following environment:

- `DISPLAY=:1` - X11 display for the virtual framebuffer
